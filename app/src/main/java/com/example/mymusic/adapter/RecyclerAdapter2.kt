...
class RecyclerAdapter2(var context :Context, var list: MutableList<Unsplaceapi>):RecyclerView.Adapter<RecyclerAdapter2.InerClass>() {
    ...
    class InerClass(ItemView: View):RecyclerView.ViewHolder(ItemView) {
        ...
        fun bindView(unsplaceapi: Unsplaceapi){
            ...
            text1.text = unsplaceapi[position].user.name
            text2.text = unsplaceapi[position].user.bio
