...
class RecyclerAdapter2(var context :Context, var list: MutableList<Unsplaceapi>,var onClickBottom:OnClickBottom):RecyclerView.Adapter<RecyclerAdapter2.InerClass>() {
